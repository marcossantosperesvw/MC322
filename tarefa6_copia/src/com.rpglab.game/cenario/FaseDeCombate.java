...
public class FaseDeCombate implements Fase {
    ...
    private Dificuldade dificuldade_atual;
    // Construtor padrão para JAXB
    public FaseDeCombate() {
        this.monstros = new ArrayList<>();
    }

    public FaseDeCombate(TipoCenario tipoCenario, Monstro... monstros, Dificuldade dificuldade_atual) {
        this.tipoCenario = tipoCenario;
        this.monstros = Arrays.asList(monstros);
        this.concluida = false;
        this.dificuldade_atual = dificuldade_atual;
    }
    public Dificuldade getDificuldade_atual() {
